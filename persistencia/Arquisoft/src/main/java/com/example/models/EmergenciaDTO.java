...
public class EmergenciaDTO {
     ...
     * @param consec 
     */
    public EmergenciaDTO(int i,String descr, List<VehiculoDTO> vehInv, String magn, UbicacionDTO ubic, Date fec, String consec) throws OperacionInvalidaException
    {
     ...
     * @return 
     */
    public List<VehiculoDTO> getVehiculosInvolucrados()
    {
     ...
     * @param vehInv 
     */
    public void setVehiculosInvolucrados(List <VehiculoDTO> vehInv)
    {
     ...
     * @param nueva 
     */
    public void setUbicacion(UbicacionDTO nueva)
    {
        ubicacion=nueva;
    }
